...
public class ParenthesisChecker {
   ...
   public static int checkParentheses(StackInterface<Character> stack, String fromString) throws ParenthesesException {
      ...
      while (i < fromString.length()) {
         char input = fromString.charAt(i);
         if (input == '(' || input == '[' || input == '{') {
            ...
            if (stack.isEmpty()) {
               throw new ParenthesesException("No left parenthesis", ParenthesesException.TOO_MANY_CLOSING_PARENTHESES);
            }
            char out = stack.pop();
            if (out == '(' && input != ')' || out == '[' && input != ']' || out == '{' && input != '}') {
               throw new ParenthesesException("Inconsistent left and right parentheses",
      ...
      if (!stack.isEmpty()) {
         throw new ParenthesesException("Too many left parentheses", ParenthesesException.TOO_FEW_CLOSING_PARENTHESES);
      }
      return j;
   }
}
