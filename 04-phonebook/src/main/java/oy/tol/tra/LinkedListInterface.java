...
public interface LinkedListInterface<E> {
     ...
     * @throws LinkedListAllocationException If failed to allocate a new list
     *                                       element.
     */
     ...
     * @throws LinkedListAllocationException If failed to allocate a new list
     *                                       element.
     * @throws IndexOutOfBoundsException     If the specified index to the list is
     *                                       out of bounds.
     */
     ...
     * @throws IndexOutOfBoundsException If the specified index to the list is out
     *                                   of bounds.
     */
